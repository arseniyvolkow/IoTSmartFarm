...
def get_actuator_service(
    db: db_dependency, access_service: AccessService = Depends(get_access_service)
) -> ActuatorService:
...
ActuatorServiceDependency = Annotated[ActuatorService, Depends(get_actuator_service)]
