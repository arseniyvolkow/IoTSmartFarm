...
@pytest.fixture
def override_dependencies(mock_influx_service, mock_mqtt_service, mock_redis_service, mock_settings):
    ...
    admin_user = UserIdentity({"sub": "admin", "g_perms": {"w_all": True, "r_all": True}})
