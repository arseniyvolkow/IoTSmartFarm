...
@patch(
    "user_service.services.auth_service.is_token_blacklisted", new_callable=AsyncMock
)
@patch(
    "user_service.services.auth_service.add_token_to_blacklist", new_callable=AsyncMock
)
@patch("user_service.services.auth_service.create_access_token")
@patch("user_service.services.auth_service.create_refresh_token")
